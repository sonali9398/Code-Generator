...
#GOOGLE_APPLICATION_CREDENTIALS=r"C:\Users\dataanalyst5.mum\Downloads\loyal-column-433705-u7-ab8f7a20b7a1.json"
...
def extract_text_from_file(file):
    ...
    if file_ext == 'pdf':
        ...
        if text:
            ...
            # If no text, use Google Vision API for image recognition
            file.seek(0)
            content = file.read()
            ...
            return "Image content detected: " + ", ".join(descriptions)
